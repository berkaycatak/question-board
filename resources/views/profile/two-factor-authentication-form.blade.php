    ...
    <x-slot name="content">
        ...
        @if ($this->enabled)
            ...
            @if ($showingRecoveryCodes)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        {{ __('Bu kurtarma kodlarını güvenli bir biçimde saklayın. İki faktörlü kimlik doğrulama cihazınızız kaybolursa, hesabınıza erişimi kurtarmak için kullanılabilirler.') }}
                    </p>
                </div>
